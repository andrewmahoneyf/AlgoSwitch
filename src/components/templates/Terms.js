    ...
    render() {
        return (
            <section className="terms bg-light pb-5">
                <h2 className="pt-5">Coinglomerate AlgoSwitch Terms of Service</h2>
                <div className="container text-left">
                    <h3>1. Terms</h3>
                    <p>By accessing the website at <a href="http://algoswitch.co">http://algoswitch.co</a>, you are
...
export default withAuthorization(authCondition)(Terms);