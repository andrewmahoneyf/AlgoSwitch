    ...
    data: (canvas) => {
        ...
        return {
            ...
            datasets: [{
                ...
                borderWidth: 2,
                data: [10243.4, 14898.5, 17458.1, 16986.5, 16288.3, 17340.6, 18467.2, 17486.3, 18579.8, 19563.3, 20288.3, 19784.9]
            }]
        }
    },
    options: {
    ...
    data: (canvas) => {
        ...
        return {
            ...
            datasets: [{
                ...
                fill: true,
                borderWidth: 1,
                data: [.0342,.0108,.0208,.0119,.0211,.0217,.0123,.0215,.012,.0321,.0177,.0214]
            }]
        }
    },
    options: {
