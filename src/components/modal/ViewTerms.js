...
class ViewTerms extends React.Component {
    ...
    render() {
        return (
            <div>
                I have read and accepted the <a href="#terms" onClick={this.toggle}>Terms and Services</a>
                <Modal
                    isOpen={this.state.modal}
                    toggle={this.toggle}
                    className={this.props.className}>
                    <ModalHeader toggle={this.toggle}>Coinglomerate AlgoSwitch Terms of Service</ModalHeader>
                    <ModalBody>
                        <h3>1. Terms</h3>
                        <p>By accessing the website at
                            <a href="http://algoswitch.co">http://algoswitch.com</a>, you are
